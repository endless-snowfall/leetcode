...
Approach:
    ...
    - MIN_INT is -2,147,483,648, so if -1,999,999,999 was reversed it would exceed that.
        - Assumption: Limit to MIN_INT.
    - MAX_INT is 2,147,483,647, so if 1,999,999,999 was reversed it would exceed that.
        - Assumption: Limit to MAX_INT.
...
Notes:
    - Assumption turned out to be wrong, LeetCode was expecting 0 where MIN/MAX Integer boundaries
        were crossed.
